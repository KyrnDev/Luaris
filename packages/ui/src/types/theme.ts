...
export type TSurfaceColours = 'base' | 'raised' | 'sunken' | 'overlay' | 'border';
export type TSizes = '2xs' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl';
export type TSpaceSizes = TSizes;
export type TControlHeights = TSizes;
export type TControlPaddingInlineSizes = TSizes;
export type TControlPaddingBlockSizes = TSizes;
export type TControlGaps = TSizes;
export type TControlIconSizes = TSizes;
