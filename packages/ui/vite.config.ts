	...
	build: {
		lib: {
			entry: {
				...
				'components/date-time-picker': resolve(__dirname, 'src/components/date-time-picker/index.ts'),
				'components/date-time-range-picker': resolve(__dirname, 'src/components/date-time-range-picker/index.ts'),
				...
				'components/tab': resolve(__dirname, 'src/components/tab/index.ts'),
				...
				'components/time-picker': resolve(__dirname, 'src/components/time-picker/index.ts'),
				'components/time-range-picker': resolve(__dirname, 'src/components/time-range-picker/index.ts'),
				'components/timeline': resolve(__dirname, 'src/components/timeline/index.ts'),
				'components/timeline-item': resolve(__dirname, 'src/components/timeline-item/index.ts'),
				'components/toast': resolve(__dirname, 'src/components/toast/index.ts'),
				'components/toasts': resolve(__dirname, 'src/components/toasts/index.ts'),
